...
use App\Http\Controllers\v1\BinController;
use App\Http\Controllers\v1\BrandController;
use App\Http\Controllers\v1\BusinessEntityAddBankAccountController;
use App\Http\Controllers\v1\BusinessEntityAddressController;
use App\Http\Controllers\v1\CategorySubcategoriesController;
use App\Http\Controllers\v1\ControlCashRegisterController;
use App\Http\Controllers\v1\CorridorController;
use App\Http\Controllers\v1\CorridorRacksController;
use App\Http\Controllers\v1\CustomerController;
use App\Http\Controllers\v1\CustomerGetDefaultController;
use App\Http\Controllers\v1\DashboardController;
use App\Http\Controllers\v1\EmployeeController;
use App\Http\Controllers\v1\InventoryController;
use App\Http\Controllers\v1\InventoryManagementController;
use App\Http\Controllers\v1\InventoryPrintoutController;
use App\Http\Controllers\v1\LabelTypeController;
use App\Http\Controllers\v1\LevelController;
use App\Http\Controllers\v1\LevelPositionsController;
use App\Http\Controllers\v1\ListCostHistoryController;
use App\Http\Controllers\v1\ListPriceHistoryController;
use App\Http\Controllers\v1\PaymentController;
use App\Http\Controllers\v1\PaymentTypeController;
use App\Http\Controllers\v1\PersonController;
use App\Http\Controllers\v1\PhoneNumberController;
use App\Http\Controllers\v1\PhoneNumberTypeController;
use App\Http\Controllers\v1\PositionBinsController;
use App\Http\Controllers\v1\PositionController;
use App\Http\Controllers\v1\PrintoutController;
...
use App\Http\Controllers\v1\PurchaseEditProductController;
use App\Http\Controllers\v1\PurchaseHeaderDetailController;
use App\Http\Controllers\v1\PurchaseHeaderFinishPriceEditionController;
use App\Http\Controllers\v1\PurchaseLocateProductsController;
use App\Http\Controllers\v1\PurchasePaymentController;
use App\Http\Controllers\v1\RackController;
use App\Http\Controllers\v1\RackLevelsController;
use App\Http\Controllers\v1\SalesController;
use App\Http\Controllers\v1\SectionCorridorsController;
use App\Http\Controllers\v1\SectionLocationController;
use App\Http\Controllers\v1\ShipMethodController;
use App\Http\Controllers\v1\StockByTypeController;
use App\Http\Controllers\v1\StockController;
use App\Http\Controllers\v1\UnitMeasureController;
use App\Http\Controllers\v1\UnPaidSalesController;
use App\Http\Controllers\v1\UserController;
use App\Http\Controllers\v1\VendorController;
use App\Http\Controllers\v1\VendorProductsController;
use App\Http\Controllers\v1\WarehouseController;
use App\Http\Controllers\v1\WarehouseSectionsController;
